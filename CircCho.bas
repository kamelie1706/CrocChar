...
170 FOR n%=0 TO 90
171 s%(n%)=SIN(n%)*r%:c%(n%)=COS(n%)*r%
175 LOCATE xo+xp*s%(n%)/8,yo+yp*c%(n%)/8:?c$;:LOCATE xo+s%(n%)/8,yo+c%(n%)/8:?ci$;
176 LOCATE xo-xp*s%(n%)/8,yo+yp*c%(n%)/8:?c$;:LOCATE xo-s%(n%)/8,yo+c%(n%)/8:?ci$;
177 LOCATE xo-xp*s%(n%)/8,yo-yp*c%(n%)/8:?c$;:LOCATE xo-s%(n%)/8,yo-c%(n%)/8:?ci$;
178 LOCATE xo+xp*s%(n%)/8,yo-yp*c%(n%)/8:?c$;:LOCATE xo+s%(n%)/8,yo-c%(n%)/8:?ci$;
179 NEXT n%
